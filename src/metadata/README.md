 ...
 * [cryo.yml](cryo.yml)
     * Determines how your purl.obolibrary.org/obo/cryo/ redirects will be handled
     ...
     * Paste in the contents of [cryo.yml](cryo.yml)
 ...
 * [cryo.md](cryo.md)
     ...
     * Paste in the contents of [cryo.md](cryo.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
